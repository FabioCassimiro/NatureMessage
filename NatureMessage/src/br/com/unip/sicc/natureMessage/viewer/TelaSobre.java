...
public class TelaSobre {
    ...
    public JPanel montaPainelSobre() {
        ...
        JButton btnVoltar = Componentes.btnIcon(componentes.image("/br/com/unip/sicc/natureMessage/image/setaVoltar.png"), 15, 10, 25, 25, new ActionListener() {
            @Override
        ...
        pnlSobre.add(Componentes.lblTexto("SOBRE", 25, Color.WHITE, 400, 50, 350, 100));
